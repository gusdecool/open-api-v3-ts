...
export default interface Parameter {
     ...
     * (cannot be serialized), the value of allowEmptyValue SHALL be ignored. Use of this property is NOT RECOMMENDED,
     ...
     *
     * @see https://spec.openapis.org/oas/v3.1.0#style-values Style values
     */
    style?: string;
    ...
    // A parameter MUST contain either a schema property, or a content property, but not both. When example or
    // examples are provided in conjunction with the schema object, the example MUST follow the prescribed serialization
